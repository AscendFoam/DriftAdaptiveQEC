...
| `LT-2025-NMF-HORIZON` | main | 文献 train 10/eval 1000；项目预注册 `1e3/1e5/1e6` cycles 的 hidden boundedness、数值稳定性和 gain retention | future holdout；不可选模 | `REGISTERED_PENDING` | T5.4.5 |
