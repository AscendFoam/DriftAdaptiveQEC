...
| R24 | Current `statcalib` lane is still only a bounded extension-lane comparator path; even after T67, if T30 helper, T59/T60/T62 smoke evidence, T64 bounded extension-lane win, T66 local sensitivity outputs, or T67 teacher-anchor outputs are overstated as a full statcalib/calibration comparator, the repo would overclaim unvalidated algorithm capability | 中 | `docs/review/T30_review.md` N4; `docs/review/T59_review.md`; `docs/review/T60_review.md`; `docs/review/T62_review.md`; `docs/review/T64_review.md`; `docs/review/T65_review.md`; `docs/review/T66_review.md`; `docs/review/T67_review.md`. T64 proves one clean bounded extension lane under the locked protocol, T65 hardens report/artifact consistency, T66 shows that the bounded win survives one local five-point sensitivity grid, and T67 shows that the bounded win is not grossly dependent on `teacher_mode=ukf`; however, two T67 comparison rows remain `mixed`, and the current strongest aggregate lane is still not a clean generated-only result pack | Keep `statcalib` labeled as a separately labeled extension lane in all FR8 docs, figures, and gates; carry the mixed-row caveat forward; do not upgrade T64/T65/T66/T67 outputs into full calibration comparator, `.tflite`, or real-board evidence without a new bounded validation task; use T68 to test generated-only robustness without rewriting `T24` |
