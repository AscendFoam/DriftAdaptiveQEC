...
| R24 | Current `statcalib` lane is still only a minimal comparator-semantics path; if T30 helper, T59/T60/T62 smoke evidence, T64 bounded extension-lane win, or later T66 sensitivity outputs are overstated as a full statcalib/calibration comparator, the repo would overclaim unvalidated algorithm capability | 中 | `docs/review/T30_review.md` N4; `docs/review/T59_review.md`; `docs/review/T60_review.md`; `docs/review/T62_review.md`; `docs/review/T64_review.md`; `docs/review/T65_review.md`. T64 proves one clean bounded extension lane under the locked protocol, and T65 hardens report/artifact consistency, but neither task turns the lane into independent calibration search or mature comparator validation | Keep `statcalib` labeled as a separately labeled extension lane in all FR8 docs, figures, and gates; do not upgrade T64/T65/T66 outputs into full calibration comparator, `.tflite`, or real-board evidence without a new bounded validation task |
