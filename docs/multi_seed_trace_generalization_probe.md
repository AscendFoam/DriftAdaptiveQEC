...
This document reports the results of a Phase A multi-seed trace-only generalization probe, following the mechanism-evidence plan defined in `docs/seed_mechanism_multi_seed_plan.md` (T46).
