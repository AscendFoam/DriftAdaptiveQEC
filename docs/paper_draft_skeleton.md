...
Method-forward title (option 3) as the current working framing, subject to later Captain/human override, with evidence-bounded body text. See `docs/paper_method_positioning_calibration.md` for the full calibration analysis and rationale.
