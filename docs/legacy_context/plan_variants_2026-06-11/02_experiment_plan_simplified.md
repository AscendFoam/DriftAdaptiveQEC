...
| T2 | 跑通最小 P0 smoke benchmark | `docs/recovery_bootstrap/P0_smoke_bootstrap.md`，首次 P0 smoke 成功 |
| T3 | 审计 HIL/P4 链路 mock/stub/placeholder 边界 | `docs/03_hil_p4_boundary_audit.md` |
| T4 | 补软件 HIL 最小 bootstrap/smoke test | `cnn_fpga/config/hardware_hil_recovery_smoke.yaml`，`docs/recovery_bootstrap/P3_software_hil_bootstrap.md` |
...
5. **三条 recovery bootstrap 文档**：`docs/recovery_bootstrap/P0_smoke_bootstrap.md`、`docs/recovery_bootstrap/P3_software_hil_bootstrap.md`、`docs/recovery_bootstrap/P4_benchmark_recovery_bootstrap.md`
...
以下缺口不影响当前结论成立，但补上后将增强论文说服力；当前计划入口以 `docs/02_experiment_plan.md` 的 Part II 为准：
...
**项目方案与结论**：
- [docs/legacy_context/reference_retired_2026-06-11/CNN_FPGA_GKP_工程化实验方案.md](legacy_context/reference_retired_2026-06-11/CNN_FPGA_GKP_工程化实验方案.md) — 工程方案全文
