...
**源文档：**
- `docs/legacy_context/reference_retired_2026-06-11/CNN_FPGA_GKP_工程化实验方案.md` — 工程方案全文（双回路架构、时序预算、实验矩阵）
- `docs/CNN_FPGA_GKP_阶段结论.md` — 阶段结论全文（P0-P4 所有正式结果、参数调优、overflow 拆分）
- `docs/02_experiment_plan.md` — 当前后续开发计划唯一入口；本文档为旧 lite 快照
- `docs/paper_notes/README.md` — 论文 note 与 LaTeX 草稿目录索引
...
- 产出：`docs/recovery_bootstrap/P0_smoke_bootstrap.md`
...
- 产出：`cnn_fpga/config/hardware_hil_recovery_smoke.yaml`、`docs/recovery_bootstrap/P3_software_hil_bootstrap.md`、`docs/tasks/P0/T4_software_hil_bootstrap_and_smoke.md`
...
- 产出：`cnn_fpga/config/p4_multiscenario_recovery_smoke.yaml`、`docs/recovery_bootstrap/P4_benchmark_recovery_bootstrap.md`
...
**当前计划入口**：[docs/02_experiment_plan.md](docs/02_experiment_plan.md)
...
**项目方案与结论**：
- [docs/legacy_context/reference_retired_2026-06-11/CNN_FPGA_GKP_工程化实验方案.md](legacy_context/reference_retired_2026-06-11/CNN_FPGA_GKP_工程化实验方案.md) — 工程方案全文（双回路架构/时序预算/参数映射规则/实验矩阵）
- [docs/CNN_FPGA_GKP_阶段结论.md](docs/CNN_FPGA_GKP_阶段结论.md) — 阶段结论全文（P0-P4 所有正式结果）
- [docs/02_experiment_plan.md](docs/02_experiment_plan.md) — 当前后续开发、投稿路线、论文提纲与 paper-inspired 分支统一计划入口
- [docs/paper_notes/README.md](docs/paper_notes/README.md) — 论文 note 与 LaTeX 草稿索引
- [docs/legacy_context/p4_early_analysis_2026-04/P4_UKF正式结果与Hybrid机制分析.md](docs/legacy_context/p4_early_analysis_2026-04/P4_UKF正式结果与Hybrid机制分析.md) — UKF 修正与 Hybrid 机制分析
...
- [docs/recovery_bootstrap/P0_smoke_bootstrap.md](docs/recovery_bootstrap/P0_smoke_bootstrap.md) — P0 smoke 复用说明
- [docs/recovery_bootstrap/P3_software_hil_bootstrap.md](docs/recovery_bootstrap/P3_software_hil_bootstrap.md) — P3 software HIL 复用说明
- [docs/recovery_bootstrap/P4_benchmark_recovery_bootstrap.md](docs/recovery_bootstrap/P4_benchmark_recovery_bootstrap.md) — P4 recovery bootstrap 说明
