...
T42 在已有论文骨架（`docs/paper_draft_skeleton.md`）基础上做了三件事：
...
2. **校准了论文标题和定位**。产出了 `docs/paper_method_positioning_calibration.md`，对比了两种定位：
...
3. 在正文撰写过程中，持续对照 `docs/paper_claim_evidence_ledger.md` 和 `docs/paper_reviewer_risk_audit.md` 确保措辞不越界。
