...
- `T15`：在 `docs/protocols/benchmark/P4_benchmark_development_protocol.md` 约束下执行双场景、五模式、`repeats=2` 的 development bounded run
...
该 run 不属于 recovery smoke 本身，而属于 `docs/protocols/benchmark/P4_benchmark_development_protocol.md` 中定义的 `development bounded run`。
