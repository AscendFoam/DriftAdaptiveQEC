...
\author{}
\date{Evidence-synchronized manuscript note; snapshot through T7.1.3, 20 July 2026}
...
live artifacts.  T7.1.2 and T7.1.3 then map the contract, safety, V4 result, and
pre-board boundary into four evidence-frozen main figures without changing the
claim states.  Together they permit a restricted simulator/pre-board contract
paper and reject a broad cross-lane performance or hardware-ranking paper.
Future prose and supplementary work can clarify this result, but only new
registered evidence can upgrade it.
