...
\author{}
\date{Evidence-synchronized manuscript note; snapshot through T7.1.2, 20 July 2026}
...
The earlier presentation schematic in Fig.~\ref{fig:dual-loop-architecture}
is retained because its interface structure survives the move away from a
...
live artifacts.  It permits a restricted simulator/pre-board contract paper
and rejects a broad cross-lane performance or hardware-ranking paper.  Future
main-figure and prose work can clarify this result, but only new registered
evidence can upgrade it.
