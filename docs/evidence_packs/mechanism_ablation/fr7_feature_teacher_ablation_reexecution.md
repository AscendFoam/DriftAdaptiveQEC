...
`docs/paper_materials/paper_ablation_result_pack.md` and `docs/paper_materials/paper_claim_evidence_ledger.md` can now truthfully cite FR7 as a present bounded result table.
