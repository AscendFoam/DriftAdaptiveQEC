...
This document reports the results of a Phase B multi-seed I1 residual-clip intervention probe, following the mechanism-evidence plan defined in `docs/evidence_packs/mechanism_ablation/seed_mechanism_multi_seed_plan.md` (T46) and the Phase A generalization findings in `docs/evidence_packs/mechanism_ablation/multi_seed_trace_generalization_probe.md` (T54).
