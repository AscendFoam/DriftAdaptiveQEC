...
| F2 | Benchmark evidence-boundary diagram: P3 software HIL, T24 revalidation, TFLite boundary, real-board readiness | `ready` | `docs/03_hil_p4_boundary_audit.md`<br>`docs/protocols/benchmark/P4_benchmark_formal_protocol.md`<br>`docs/evidence_packs/deployment_boundary/TFLite_runtime_bootstrap.md`<br>`docs/evidence_packs/deployment_boundary/real_board_hil_readiness.md` | Schematic figure from boundary docs | Safe as boundary diagram. |
