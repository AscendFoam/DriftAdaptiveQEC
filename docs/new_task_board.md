...
当前推荐任务：`T6.25.4`（T6.25.3 已对 T6.25.2 exact converged top 从 current source 重建 independent golden，并完成 10 family×100,000=`1,000,000` cycles 的 CXXRTL 全 148-byte 公开输出逐周期对拍：0 mismatch、source-to-action=6、MAP=5、II=1 pair `998,435/998,435`，输入/MAP/route/output 数量守恒；full-image、host/policy commit、cancel/drain/snapshot、11 类 reject、可注入/结构保护 fault、compound transport 均闭合。19/19 gates、148/148 comparator-byte mutations、21/21 semantic mutations、14 focused/88 joint tests 通过；旧 golden 未复用。下一步仅对该 exact qualified top 完成至少三 seed synthesis/P&R、资源/时序/功耗敏感性；multimode pilot/formal 保持未访问，板测、fastest、multimode decoder-in-RTL claim 继续关闭）。
