...
> 维护说明（2026-06-11）：本文已从拼写错误的 `docs/stucture_explanation/` 移入 `docs/codebase_overview/` 并改名为 `cnn_fpga_directory_structure.md`。它是 `cnn_fpga/` 代码阅读辅助，不是当前项目计划或证据状态来源。文中的文件列表、命令和阶段定位可能落后于后续 T 系列任务；涉及当前任务、P4 benchmark、`.tflite`、real-board、statcalib 或论文 claim 时，请以 `docs/02_experiment_plan.md`、`docs/04_task_board.md`、`docs/07_handoff.md` 和 `docs/08_risks_and_open_questions.md` 为准。
