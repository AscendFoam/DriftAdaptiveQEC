...
> 维护说明（2026-06-11）：本文已从 `docs/intro/` 移入 `docs/codebase_overview/`。它是 `physics/` 代码阅读辅助，不是当前项目计划或证据状态来源。涉及当前任务、P0-P4 证据边界、`.tflite`、real-board、statcalib 或论文 claim 时，请以 `docs/02_experiment_plan.md`、`docs/04_task_board.md`、`docs/07_handoff.md` 和 `docs/08_risks_and_open_questions.md` 为准。
