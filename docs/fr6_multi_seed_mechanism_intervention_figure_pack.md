...
| Caption boundary | `docs/post_t55_mechanism_claim_reframing_gate.md` | T56 wording boundary | Keep the figure descriptive; no causal proof, mitigation-success claim, or mechanism closure wording |
