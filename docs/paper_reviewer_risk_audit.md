...
This audit assumes an adversarial reviewer. The purpose is to identify where the current paper state is vulnerable if drafting drifts beyond the evidence ledger in `docs/paper_claim_evidence_ledger.md`.
