...
This document calibrates the paper's framing against the claim/evidence ledger (`docs/paper_claim_evidence_ledger.md`, C1–C11) and the Milestone 2K review (`docs/review/Milestone2K_review.md`). It compares two framing options, recommends the safe choice, and lists forbidden phrases that would upgrade blocked claims.
