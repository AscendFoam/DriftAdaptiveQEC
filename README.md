...
- `docs/`: 方案、阶段结论、恢复治理文件
  ...
  - `docs/new_tasks/T-RISK-20260728-04_resource_preflight_abort_full_v5_20260730_102415.md`：首个V5 resource在37,506秒、formal-LPT四worker、0 receipt时被不同boot-session证明的外部主机重启中断；仅START事件、7,414点连续采样和8.12GB未发布staging只读保留，不是OOM、backend disagreement或科学NO-GO，也不得进入V2 seal
