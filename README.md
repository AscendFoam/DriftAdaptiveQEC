...
- `docs/`: 方案、阶段结论、恢复治理文件
  ...
  - `docs/paper_notes/Contract_Centric_Regime_Aware_GKP_note_draft.tex`: 截止 T7.2.5 的 50 页 restricted pre-board Route-A 正式论文式 note；Introduction/Related Work、Methods、Results、8段Discussion/Conclusion 和九段 Supplement 均按 contract/task-signature/evidence-state 边界组织，正式 Fig.1--4、Supplement S1--S5、N/A/null/failed 与 long-RTL denominator 不隐藏负结果、V5 stop、物理缺口或 board-null
