...
- `docs/`: 方案、阶段结论、恢复治理文件
  ...
  - `docs/t9_2_4_twin_qualification_preregistration.json` / `configs/phase9/t9_2_4_twin_qualification.json`：T9.2.4 在正式 A/B outcome 访问前冻结的 immutable qualification seal；六态×七动作、五个共同物理初态、全部16个 conservative probes、四个 fault family、14,976 backend-round/384 trajectories、四段互斥seed、18个 tolerance、simultaneous family与NO-GO分支。20/20 gates/mutations、16项 tests通过，当前只允许启动已封印的 formal runner，不代表 dual-backend agreement或任何性能/外部 claim
