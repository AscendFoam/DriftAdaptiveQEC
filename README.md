...
- `docs/`: 方案、阶段结论、恢复治理文件
  ...
  - `docs/new_tasks/T-RISK-20260728-04_resource_preflight_abort_full_v5_20260730_102415.md` / `docs/new_tasks/T-RISK-20260728-04_resource_preflight_abort_full_v5b_20260807_003952.md` / `docs/new_tasks/T-RISK-20260830-01_resource_wall_feasibility_repair.md` / `docs/new_tasks/T-RISK-20260830-01_resource_preflight_abort_full_v6_20260830_043859.md` / `cnn_fpga/benchmark/phase9_powered_twin_resource_forensics.py`：V5c只读取证重放得到four-worker total=`4,293,111.851 s`、artifact=`129,165,799,929 B`。backend-B structured channel对dense reference max-abs `<=2e-16`、cutoff44 sense样本median `8.767x`、205/205 tests；但fresh V6在0 row/receipt时被旧T03 byte binding正确拒绝。默认replacement因会弱化provenance而被安全审查拒绝并撤回；须用户授权新建显式byte-bound equivalence child contract，旧T03证据保持不变。当前T04仍Blocked，完整投影未PASS前不得启动formal run
