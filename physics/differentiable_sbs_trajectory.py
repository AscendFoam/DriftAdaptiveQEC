...
def run_differentiable_sbs_validation(
    *,
    ...
    """Run the validation artifact implemented outside the simulator core."""

    from ._differentiable_sbs.validation import run_differentiable_sbs_validation

    return run_differentiable_sbs_validation(
        device=device,
        cutoff=cutoff,
        output=output,
    )
...
if __name__ == "__main__":
    from ._differentiable_sbs.validation import main
