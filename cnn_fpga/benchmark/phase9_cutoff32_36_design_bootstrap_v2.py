"""Verified trusted-operator entrypoint for the V2 cutoff diagnostic only.
...
then this module loads the reader-repair child, sealed design runner and V2
diagnostic from their preregistered bytes.  This repair entrypoint cannot
launch or rerun the design transaction and cannot release the powered formal.
...
EXTERNAL_LAUNCHER_SOURCE = (
    ...
    "path=root/'cnn_fpga/benchmark/phase9_cutoff32_36_design_bootstrap_v2.py'\n"
...
RELEASED_CHILD_BYTES = 3920
RELEASED_CHILD_SHA256 = (
    "b0cb6b1c509ce06db30947d5f4a44410f5c83d53b9c1e672ddc14f1f73faaeb6"
)
RUNNER_MODULE = "cnn_fpga.benchmark.phase9_cutoff32_36_design_extension"
RUNNER_PATH = "cnn_fpga/benchmark/phase9_cutoff32_36_design_extension.py"
RUNNER_SHA256 = "b00f13141c92fff992ae90f487497a4d8da3b36698fa4584d1a2aa0c3c75d8c3"
DIAGNOSTIC_MODULE = "cnn_fpga.benchmark.phase9_cutoff32_36_design_diagnostic_v2"
DIAGNOSTIC_PATH = "cnn_fpga/benchmark/phase9_cutoff32_36_design_diagnostic_v2.py"
DIAGNOSTIC_SHA256 = "ac364a0f1b6bff6a0eb227479f9ee8fd7d468f3b0d24399644219db66375dea9"
...
def _commit_launch_meta(
    ...
    if mode != "diagnostic":
        raise RuntimeError("V2 bootstrap is diagnostic-only")
    launcher_sha, bootstrap_binding = _external_launcher_contract(mode)
    relative = DIAGNOSTIC_LAUNCH_META_PATH
...
class _FrozenFinder(importlib.abc.MetaPathFinder):
    ...
    def find_spec(
        ...
        return importlib.util.spec_from_loader(
            fullname,
            _FrozenLoader(fullname, self.path, self.payload, self.digest),
...
def _load_verified(fullname: str, relative: str, expected_sha256: str) -> Any:
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Verified V2 cutoff32/36 diagnostic-only entrypoint."
    )
    parser.add_argument(
        "mode",
        choices=("diagnostic",),
    ...
    diagnostic = _load_verified(DIAGNOSTIC_MODULE, DIAGNOSTIC_PATH, DIAGNOSTIC_SHA256)
